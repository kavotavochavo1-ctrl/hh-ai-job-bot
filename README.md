...
- поиск удалённых вакансий по всей России без регионального ограничения;
...
- асинхронное Python-приложение и Telegram Bot API;
- интеграцию с LLM через OpenRouter;
- браузерную автоматизацию на Playwright;
- работу с публичными web-страницами и структурированными данными;
- SQLite и SQLAlchemy Async;
- Docker Compose и эксплуатацию на Ubuntu VPS;
- защиту секретов, идемпотентность и безопасные остановки;
- тестирование внешних интеграций через fakes и моки.
